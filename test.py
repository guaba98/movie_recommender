...
def get_recommendations(title):
    ...
    return titles.iloc[movie_indices]  # 영화 타이틀에서 인덱스 값을 기준으로 영화 제목들을 뽑아온다. 그리고 이 값을 리턴한다.

print(get_recommendations('The Godfather').head(10)) # 총 30개의 값이 들어있는 영화 관련도 높은 자료들
